...
const faqs = [
  {
    ...
    answer:
      "Nano Banana is an advanced AI image editing platform that transforms photos using natural language prompts. Our model delivers exceptional consistency and accuracy for character editing and scene preservation, helping you achieve professional-quality results with simple text instructions.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Our model excels in character consistency, scene blending, and one-shot editing. It preserves facial features seamlessly while integrating edits with backgrounds. We also support multi-image context, making it ideal for creating consistent AI-generated content.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "You can access Nano Banana through our web interface. Simply upload your image, enter a text prompt describing your desired edits, and watch as our AI transforms your photo with incredible accuracy and consistency.",
  },
]
